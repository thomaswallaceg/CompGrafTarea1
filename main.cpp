...
void dibujarPalo(float angPalo, float distPalo, double blancaX, double blancaY){
    ...
    glBegin(GL_LINES);
        glVertex3f(0,0.4+distPalo,0);
        glVertex3f(0,5+distPalo,0);
    glEnd();
    glPopMatrix();
 }
...
void actualizarCam(float &x,float &y, float &z, float x_angle, float y_angle,float radius){
    z = cos(y_angle*3.141592/180) * cos(x_angle*3.141592/180) * radius;
    x = sin(y_angle*3.141592/180) * cos(x_angle*3.141592/180) * radius;
    y = sin(x_angle*3.141592/180) * radius;
}
...
//        gluLookAt(x,y,-z,0,0,0,0,1,0);
        gluLookAt(x+2.5,y+1,-z+12,2.5,1,12,0,1,0);
...
*/
        ...
        while(SDL_PollEvent(&evento)){
            ...
            case SDL_MOUSEBUTTONDOWN:
                ...
                if(evento.button.button == SDL_BUTTON_RIGHT) girarPalo=false;
                break;
            ...
            case SDL_MOUSEMOTION:
                if(moverCam){
                    ...
                    if (girarPalo) angPalo += evento.motion.xrel*0.4;
                    else if (distPalo > 0.5) distPalo += evento.motion.yrel*0.4;
                }
                break;
            case SDL_QUIT:
                fin = true;
